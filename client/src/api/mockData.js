...
export const mockProducts = [
  {
    ...
    description: 'Premium 65-inch QLED 4K Smart TV with HDR10+ and built-in Alexa support for ultimate entertainment experience.',
    category: 'cat-001',
    price: 89999,
    colour: 'Titan Gray',
    specification: '65" QLED 4K Display, HDR10+, Smart TV, Built-in Alexa, 3 HDMI ports, WiFi enabled',
    stockQuantity: 12,
    stockStatus: 'InStock',
    brand: 'Samsung',
    isActive: true,
  ...
  },
  {
    ...
    description: 'Energy-efficient 7kg front load washing machine with AI DD technology and steam wash for better fabric care.',
    category: 'cat-005',
    price: 42999,
    colour: 'White',
    specification: '7kg Capacity, Front Load, AI DD Technology, Steam Wash, 1400 RPM, Energy Star 5 Rated',
    stockQuantity: 8,
    stockStatus: 'InStock',
    brand: 'LG',
    isActive: true,
  ...
  },
  {
    ...
    description: 'Spacious 265L double door refrigerator with advanced cooling technology and energy efficiency.',
    category: 'cat-004',
    price: 28999,
    colour: 'Arctic Steel',
    specification: '265L Capacity, Double Door, Frost Free, 5 Star Energy Rating, Advanced Cooling Technology',
    stockQuantity: 15,
    stockStatus: 'InStock',
    brand: 'Whirlpool',
    isActive: true,
