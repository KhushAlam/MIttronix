...
function BlogEdit() {
    ...
    const loadBlog = async () => {
        try {
            ...
            // Parse content if it's JSON structured
            let contentText = data.content;
            try {
                const parsedContent = JSON.parse(data.content);
                if (Array.isArray(parsedContent)) {
                    contentText = parsedContent.map(section => section.content || '').join('\n\n');
                }
            } catch {
            ...
            setFormData({
                ...
                isCommentEnabled: data.isCommentEnabled !== undefined ? data.isCommentEnabled : true,
