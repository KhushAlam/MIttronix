...
import { MdRefresh, MdLocalShipping, MdCancel, MdLocalShipping as MdShipped, MdDeliveryDining, MdPending, MdCheckCircle, MdHourglassEmpty, MdVisibility, MdEdit, MdAdd, MdReceipt } from 'react-icons/md'
          ...
          <table className="data-table">
            ...
            <tbody>
              {orders.map((order, index) => (
                <tr key={index}>
                  <td>
                    <Link to={`/orders/details/${order.id}`} className="order-link">
                      {order.id}
                    </Link>
                  </td>
